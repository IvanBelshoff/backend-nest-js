...
import { buildAuditHttpContext } from 'src/audit/utils/build-audit-http-context.util';
...
export class AuthController {
  ...
  async logout(
    ...
    await this.authService.logout(
      rawRefreshToken,
      req.user ? { sub: req.user.sub, email: req.user.email } : undefined,
      buildAuditHttpContext(req),
    );
